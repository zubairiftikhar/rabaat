      ...
      <div className="row">
        <div className="col-lg-12 col-sm-12">
          <div className="about_page">
            ...
            <p><span>Goals: </span>We aim to empower users by making it easier than ever to maximize their savings. Whether you own a credit card, debit card, or prepaid card, our platform helps you find the right discounts without any hassle</p>
          </div>
        </div>
      </div>
    </div>
